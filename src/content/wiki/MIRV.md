...
cats: []
---
<figure class="mw-default-size" typeof="mw:File/Thumb"><img src="/images/199px-M.I.R.V_Bomb.png" decoding="async" width="199" height="200" class="mw-file-element" data-file-width="414" data-file-height="416"><figcaption>A launched <b>MIRV.</b></figcaption></figure>

The MIRV (Multiple Independently-targetable Reentry Vehicle) is the most powerful nuke in the game. It is priced at 25,000,000 Gold and increase 15,000,000 gold with each MIRV launched by any player.

# Launching {#Launching}

To launch a **MIRV**, first right-click onto any (non-water) surface in the map, opening the radial menu. Then open the Build Menu at the desired country you wish to nuke and select "MIRV". Launching a MIRV requires one or more Missile Silos owned by the player launching it. The MIRV will be launched by the nearest missile silo, and will bomb the entirety of a nation, using up to 350 warheads.

### Missile behavior {#Missile_behavior}
