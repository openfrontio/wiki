...
1. The defending territory has a single owner.
2. The defending territory is not wilderness (it can be owned by a human, [bot](/Bots), or [nation](/Nations)).
3. The defending territory is fully surrounded by the attacker's borders (meaning it cannot have any borders the ocean, a river, or another player or bot). It may have borders with a lake, as long as it surrounds the lake, and the attacker surrounds it.
...
Using several low percentage [naval invasions](/Transport_Ship) on a coastal region which you have otherwise surrounded allows for saving on troops and time by only having to fight through a small amount of tiles to surround and then easily capture the given territory.
...
If you have a significant troop advantage on a fully surrounded player, nation or bot, and you do not need [gold](/Gold) in that exact moment, and you do not have significant [trade](/Trade), it may make sense to not conquer them right away, as the longer they are alive, [the more gold they can produce.](/Gold) Caution should be applied when using this strategy, as if you forget about the territory, and it gains a foothold elsewhere, or you lose enough troops in another attack, it may attack you with enough force to stop being surrounded and it may threaten you. Also note that bots have a slower gold production rate than players and nations (only 500 gold per second, compared to the standard 1000 gold per second).
